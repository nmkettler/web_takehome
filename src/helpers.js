...
export const allAnsweredFields = (fields, fieldOrder) => {
...
export const getTemplateNumber = newInputName => {
  return Math.floor(Math.random() * (getTextTemplates(newInputName).length - 1));
};
